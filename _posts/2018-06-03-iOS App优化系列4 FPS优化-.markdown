...
![App体积优化通用版](/Users/keke/Desktop/github/kekeYezi.github.io/assets/images/2018-06/App体积优化通用版.png)

辅助脚本：把重要的参数都记录下来。clang插件？

### 检测自己的App的表现

知己知彼才能百战不殆。谁家公司还没有个竞品分析的对手呢？首先要知道自己与知名App或者竞争对手App的一个差距才能知道自己在哪方面做的不足。以蚂蚁财富为例：

![ipa分析](/Users/keke/Desktop/github/kekeYezi.github.io/assets/images/2018-06/ipa分析.png)
...
![demo1](/Users/keke/Desktop/github/kekeYezi.github.io/assets/images/2018-06/demo1.png)
